...
def process_data(conditions):
    ...
    fromdate = conditions.get("fromdate", datetime(2023, 1, 17, 20, 0, tzinfo=pytz.UTC))
...
if __name__ == "__main__":
    conditions = {
        "symbol": "USDJPY",
        "fromdate": datetime(2024, 1, 22, 0, 0, tzinfo=pytz.UTC),
        "todate": datetime(2025, 2, 19, 18, 0, tzinfo=pytz.UTC),
        "BASE_SMA": 20,
